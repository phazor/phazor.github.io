      ...
      <div>
        <section className="Home">
          ...
          <div className="Home-intro container">
            ...
            <p>______________</p>
            <h4>state: redux</h4>
            <p>State is stored with <Link href="https://redux.js.org" target="_blank">redux</Link> in the <Link to="/user-list">UserList</Link> and <Link to="/NEOs">Near Earth Objects</Link> pages. The latter uses <Link href="https://github.com/gaearon/redux-thunk" target="_blank">redux-thunk</Link> to handle async behavior.</p>
            <p>______________</p>
            <h4>3D Graphics: three.js and WebGL</h4>
            <p>I use  <Link href="http://threejs.org/" target="_blank">three.js</Link> in the <Link to="/planets">Trappist-1</Link> solar system simulation. This abstracts away much of the low-level WebGL code and provides helpers for numerous common 3D tasks.</p>
            <p>______________</p>
