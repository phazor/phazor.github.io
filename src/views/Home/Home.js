      ...
      <div>
        <section className="Home">
          ...
          <div className="Home-intro container">
            <p>The purpose of this site is for me to learn and showcase a few tools. You can find the results as projects in the menu above. Below I have documented the tools used.</p>
            ...
            <p>This app was styled using <a href="https://milligram.github.io/">Milligram</a> as a base. The responsive menu behavior is added by me, as pure CSS.</p>
            ...
            <p>______________</p>
            <h4>state: redux</h4>
            <p>State is stored with <a href="https://redux.js.org" target="_blank">redux</a> in the <Link to="/user-list">UserList</Link> page. There is no ajax yet - so no middleware is used.</p>
            <p>______________</p>
